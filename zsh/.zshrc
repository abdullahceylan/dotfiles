...
# apple transporter
export TRANSPORTER_HOME="/usr/local/itms"
...
export PATH=$HOME/bin:/usr/local/bin:$PATH:/opt/local/bin:/usr/local/sbin:$PATH
...
alias p.rl="source ~/.zshrc; echo '~/.zshrc reloaded.'"
